...
public class Employee {
	...
	public String getExperience() {
		...
		LocalDate end = (leavingDate != null) ? leavingDate.atZone(ZoneOffset.UTC).toLocalDate()
		...
		return String.format("%d Year %d Month %d day", period.getYears(), period.getMonths(), period.getDays());
	}
	...
	public String toString() {
		return "Employee{" + "id=" + id + ", name='" + name + '\'' + ", position='" + position + '\'' + ", field='"
				+ field + '\'' + '}';
	}
}
